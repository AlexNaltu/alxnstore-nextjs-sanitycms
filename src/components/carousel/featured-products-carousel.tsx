          ...
          <SwiperSlide key={product._id}>
            <Card className="rounded-none border-none custom-shadow mb-2">
              ...
              <CardContent className="tracking-tighter font-bold px-1">
                <div>
                  <h1 className="text-base lg:text-lg line-clamp-1">
                    {product.name}
                  </h1>
                  <div>
                    {product.variants.length > 0 && (
                      <div key={product.variants[0].variant_id}>
                        ...
                        <Link
                          ...
                          className="text-base mb-1 text-primary underline hover:text-black transition-all duration-300 ease-in-out lg:text-sm"
                        >
                          Choose options
                        </Link>
                      </div>
